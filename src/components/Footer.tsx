        ...
        <>
            ...
            >
                <div
                    ...
                    <Link href="/" className="block mt-2 h-14 w-auto">
                        <img
                            src="/bus-logo1.svg"
                    ...
                    <nav
                        ...
                        <Link href="/park" className="hover:underline">Наш автопарк</Link>
                    ...
                    <button
                        ...
                        className="track-click inline-block px-4 py-2 rounded-2xl bg-white text-blue-600 font-semibold text-sm md:text-base hover:bg-gray-100 transition shadow-md"
                    >
                        Оставить заявку
                    </button>
                </div>
