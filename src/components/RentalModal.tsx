    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50">
            ...
            >
                {/* Кнопка закрытия */}
                <button
                    className="absolute top-3 right-3 sm:top-4 sm:right-4 text-gray-500 hover:text-gray-900 transition track-click"
                    onClick={onClose}
                >
                ...
                <form onSubmit={handleSubmit} className="track-form space-y-4 sm:space-y-5 pb-6">
                    {/* Тип клиента */}
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                        <button
                            ...
                            className="track-click w-full sm:flex-1 bg-blue-500 text-white px-6 py-3 rounded-lg sm:rounded-xl font-semibold shadow-md hover:bg-blue-600 transition disabled:opacity-50"
                        >
                        ...
                        <a
                            href="/dogovor.docx"
                            download
                            className="track-click w-full sm:flex-1 flex items-center justify-center gap-2 bg-gray-100 text-gray-700 px-6 py-3 rounded-lg sm:rounded-xl font-semibold shadow-md hover:bg-gray-200 transition"
                        >
                            <Download size={20}/>
                            Скачать договор
                        </a>
