                ...
                <div className="flex items-center justify-between px-6 py-3">
                    ...
                    <div className="hidden md:block flex-shrink-0">
                        <button
                            ...
                            className=" track-click bg-blue-500 text-white px-5 py-2 rounded-xl font-semibold shadow-lg hover:bg-blue-600 hover:scale-105 transition transform duration-300"
                        >
                            Оставить заявку
                        </button>
                    </div>
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            className="track-click p-2 rounded-md text-gray-700 hover:text-blue-500 transition"
                ...
                {mobileOpen && (
                    <div className="md:hidden border-t border-gray-200 bg-white/40 backdrop-blur-md rounded-b-xl shadow-lg">
                        <nav className="flex flex-col items-center gap-4 py-6 font-semibold text-gray-700">
                            ...
                            <button
                                onClick={() => setIsModalOpen(true)}
                                className="track-click bg-blue-500 text-white px-5 py-2 rounded-xl font-semibold shadow-lg hover:bg-blue-600 transition"
                            >
                                Оставить заявку
                            </button>
                        </nav>
