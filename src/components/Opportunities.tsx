...
export default function Features() {
    return (
        <section
            id="features-section"
            className="mt-5 md:mt-20 mb-20 max-w-[1400px] mx-auto w-[90%] grid grid-cols-1 md:grid-cols-2 gap-8"
        >
            <div className="md:sticky md:top-20 h-fit py-5 space-y-4">
                <h2 className="text-3xl md:text-4xl font-extrabold leading-tight text-center md:text-left">
                    Аренда автобусов по Беларуси. <br />
                    Уже{" "}
                ...
                <p className="text-base md:text-lg text-gray-800">
                    Мы не просто осуществляем перевозки — мы становимся частью вашего события.
